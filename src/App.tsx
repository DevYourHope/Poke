...
import { Search, Users, ChevronRight, Target, BookOpen, ShoppingBag, Loader2 } from 'lucide-react';
import Layout from './components/Layout';
import { AuthProvider } from './contexts/AuthContext';

// Lazy load pages for better performance
const ShinyHunting = React.lazy(() => import('./pages/ShinyHunting'));
const CustomGames = React.lazy(() => import('./pages/CustomGames'));
const Pokedex = React.lazy(() => import('./pages/Pokedex'));
const TeamAnalyzer = React.lazy(() => import('./pages/TeamAnalyzer'));
